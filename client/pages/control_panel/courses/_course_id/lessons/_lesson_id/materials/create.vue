<template>
  <div class="wrapper">
    ...
    <div class="text-h5">Тело материала</div>
    <no-ssr>
      <client-only>
        <codemirror
          v-model="form.body"
  ...
  methods: {
    async createMaterial() {
      await this.$axios.post(
        `control/courses/${this.$route.params.course_id}/lessons/${this.$route.params.lesson_id}/materials`,
        {
        ...
        this.dialog.text = 'Материал успешно создан'
